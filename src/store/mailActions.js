...
export const addMail=(mail)=>{
    ...
    return async(dispatch)=>{
        try{
        const response = await fetch(`https://mail-3c5d6-default-rtdb.firebaseio.com/${senderEmail}.json`,{
            method : "POST",
        ...
        if(senderEmail != receiverEmail){
            await fetch(`https://mail-3c5d6-default-rtdb.firebaseio.com/${receiverEmail}.json`,{
                method : "POST",
...
export const replacemail=(emailUrl , loggedUserEmail )=>{
    return async(dispatch)=>{
        try{
            ...
            const res = await fetch(`https://mail-3c5d6-default-rtdb.firebaseio.com/${emailUrl}.json`)
...
export const deleteMail=(mail)=>{
    ...
    return async (dispatch)=>{
         try{
           const res = await fetch(`https://mail-3c5d6-default-rtdb.firebaseio.com/${emailUrl}/${mail.id}.json`,
           {
            method :"DELETE"
           })
            console.log(res)
